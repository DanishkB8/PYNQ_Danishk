...
# 2 "src/am_accel.cpp" 2


__attribute__((sdx_kernel("am_accel", 0))) void am_accel(hls::stream<ap_axis<32,2,5,6>>& a,
              hls::stream<ap_axis<32,2,5,6>>& b,
              hls::stream<ap_axis<32,2,5,6>>& out)
{
#pragma HLS TOP name=am_accel
# 7 "src/am_accel.cpp"
...
#pragma HLS PIPELINE
 ...
 ap_axis<32,2,5,6> tmp1, tmp2, tmp3;
    ...
    VITIS_LOOP_16_1: while (1) {
        ...
        tmp3.keep = tmp1.keep & tmp2.keep;
        tmp3.strb = tmp1.strb & tmp2.strb;
        tmp3.user = tmp1.user;
        tmp3.id = tmp1.id;
        tmp3.dest = tmp1.dest;
        out.write(tmp3);
