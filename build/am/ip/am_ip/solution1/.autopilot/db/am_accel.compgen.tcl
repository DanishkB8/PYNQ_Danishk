...
set id 1
set name am_accel_mul_32s_32s_32_1_1
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 3 \
			corename am_accel_control_axilite \
			name am_accel_control_s_axi \
			ports {$port_control} \
			op interface \
			is_flushable 0 \ 
			is_datawidth64 0 \ 
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler am_accel_control_s_axi
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { b_TVALID { I 1 bit } b_TREADY { O 1 bit } b_TDEST { I 6 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { out_r_TVALID { O 1 bit } out_r_TREADY { I 1 bit } out_r_TDEST { O 6 vector } } \
} "
} else {
...
# RegSlice definition:
set ID 25
set RegSliceName am_accel_regslice_both
set RegSliceInstName am_accel_regslice_both_U
set CoreName ap_simcore_am_accel_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
