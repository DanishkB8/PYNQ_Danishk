; ModuleID = '/home/danishkb8/Projects/build/am/ip/am_ip/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_am_accel_ir(%"class.hls::stream"* %a, %"class.hls::stream"* %b, %"class.hls::stream"* %out) local_unnamed_addr #0 {
entry:
  %a_copy = alloca %"class.hls::stream", align 512
  %b_copy = alloca %"class.hls::stream", align 512
  %out_copy = alloca %"class.hls::stream", align 512
  call fastcc void @copy_in(%"class.hls::stream"* %a, %"class.hls::stream"* nonnull align 512 %a_copy, %"class.hls::stream"* %b, %"class.hls::stream"* nonnull align 512 %b_copy, %"class.hls::stream"* %out, %"class.hls::stream"* nonnull align 512 %out_copy)
  call void @apatb_am_accel_hw(%"class.hls::stream"* %a_copy, %"class.hls::stream"* %b_copy, %"class.hls::stream"* %out_copy)
  call fastcc void @copy_out(%"class.hls::stream"* %a, %"class.hls::stream"* nonnull align 512 %a_copy, %"class.hls::stream"* %b, %"class.hls::stream"* nonnull align 512 %b_copy, %"class.hls::stream"* %out, %"class.hls::stream"* nonnull align 512 %out_copy)
  ret void
}
...
declare void @apatb_am_accel_hw(%"class.hls::stream"*, %"class.hls::stream"*, %"class.hls::stream"*)

define void @am_accel_hw_stub_wrapper(%"class.hls::stream"*, %"class.hls::stream"*, %"class.hls::stream"*) #6 {
entry:
  ...
  call void @am_accel_hw_stub(%"class.hls::stream"* %0, %"class.hls::stream"* %1, %"class.hls::stream"* %2)
...
declare void @am_accel_hw_stub(%"class.hls::stream"*, %"class.hls::stream"*, %"class.hls::stream"*)
