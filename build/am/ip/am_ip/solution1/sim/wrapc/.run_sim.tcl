...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "am_accel.autotvin.dat"
	set constFileTvOut       "am_accel.autotvout.dat"
	set constFileHdlTvIn     "am_accel.autohdltvin.dat"
	set constFileHdlTvOut    "am_accel.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
