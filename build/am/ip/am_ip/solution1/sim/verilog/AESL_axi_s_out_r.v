...
`define TV_OUT_out_r_TDATA "../tv/rtldatafile/rtl.am_accel.autotvout_out_V_data_V.dat"
`define TV_OUT_out_r_TKEEP "../tv/rtldatafile/rtl.am_accel.autotvout_out_V_keep_V.dat"
`define TV_OUT_out_r_TSTRB "../tv/rtldatafile/rtl.am_accel.autotvout_out_V_strb_V.dat"
`define TV_OUT_out_r_TUSER "../tv/rtldatafile/rtl.am_accel.autotvout_out_V_user_V.dat"
`define TV_OUT_out_r_TLAST "../tv/rtldatafile/rtl.am_accel.autotvout_out_V_last_V.dat"
`define TV_OUT_out_r_TID "../tv/rtldatafile/rtl.am_accel.autotvout_out_V_id_V.dat"
`define TV_OUT_out_r_TDEST "../tv/rtldatafile/rtl.am_accel.autotvout_out_V_dest_V.dat"
...
module AESL_axi_s_out_r (
    ...
    input [2 - 1:0] TRAN_out_r_TUSER,
    input TRAN_out_r_TLAST,
    input [5 - 1:0] TRAN_out_r_TID,
    input [6 - 1:0] TRAN_out_r_TDEST,
    ...
    reg [2 - 1:0] out_r_TUSER_write_data;
    reg out_r_TUSER_read_en;
    wire [2 - 1:0] out_r_TUSER_read_data;
    
    fifo #(10, 2) fifo_out_r_TUSER (
        .reset(1'b0),
        .write_clock(clk),
    ...
    reg [5 - 1:0] out_r_TID_write_data;
    reg out_r_TID_read_en;
    wire [5 - 1:0] out_r_TID_read_data;
    
    fifo #(10, 5) fifo_out_r_TID (
        .reset(1'b0),
        .write_clock(clk),
    ...
    reg [6 - 1:0] out_r_TDEST_write_data;
    reg out_r_TDEST_read_en;
    wire [6 - 1:0] out_r_TDEST_read_data;
    
    fifo #(10, 6) fifo_out_r_TDEST (
        .reset(1'b0),
        .write_clock(clk),
