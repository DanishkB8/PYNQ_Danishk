...
if {[file isfile am_accel.autotvin.dat]} {
	file delete -force am_accel.autotvin.dat
}

if {[file isfile am_accel.autotvout.dat]} {
	file delete -force am_accel.autotvout.dat
}
