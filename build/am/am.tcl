...
################################################################
# This is a generated script based on design: am
#
...
if { $list_projs eq "" } {
   create_project am am -part xczu5eg-sfvc784-1-e
...
proc create_root_design { parentCell } {
  ...
  # Create instance: am_accel_0, and set properties
  set am_accel_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:am_accel:1.0 am_accel_0 ]
  ...
  connect_bd_intf_net -intf_net am_accel_0_out_r [get_bd_intf_pins am_accel_0/out_r] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins am_accel_0/a] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
  ...
  connect_bd_intf_net -intf_net axi_dma_1_M_AXIS_MM2S [get_bd_intf_pins am_accel_0/b] [get_bd_intf_pins axi_dma_1/M_AXIS_MM2S]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins am_accel_0/s_axi_control] [get_bd_intf_pins ps8_0_axi_periph/M00_AXI]
  ...
  assign_bd_address -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs am_accel_0/s_axi_control/Reg] -force
