...
if { $list_projs eq "" } {
   create_project first first -part xczu5eg-sfvc784-1-e
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M01_AXI [get_bd_intf_pins example_0/s_axi_control] [get_bd_intf_pins ps8_0_axi_periph/M01_AXI]
  ...
  assign_bd_address -offset 0xA0010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs example_0/s_axi_control/Reg] -force
